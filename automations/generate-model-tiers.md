...
Fetch the raw markdown. As of 2026-08-29 the page has **two** tables with columns: Model | Provider | Input | Cache write | Cache read | Output | Notes:
...
2. Download chunks and find the pricing catalog (search for `id:"auto-cost"` or `id:"grok-4.6"` together with `output:`). The chunk hash changes over time (2026-08-29, 2026-08-28, 2026-08-27, 2026-08-26, and 2026-08-25: `07q5_bowxn4is.js`; was `0p1ggu34p8cgd.js` on 2026-08-23; was `0qfcspezy5-zl.js` on 2026-08-21).
...
- Typical size: markdown row count + `auto` (e.g. 47 + 1 = 48 as of 2026-08-29)

...
Fetch the raw markdown. As of 2026-08-19 the page has **two** tables with columns: Model | Provider | Input | Cache write | Cache read | Output | Notes:
...
2. Download chunks and find the pricing catalog (search for `id:"auto-cost"` or `id:"grok-4.6"` together with `output:`). The chunk hash changes over time (2026-08-19: still `0gk73_w-syg9i.js`).
...
- Typical size: markdown row count + `auto` (e.g. 47 + 1 = 48 as of 2026-08-19)

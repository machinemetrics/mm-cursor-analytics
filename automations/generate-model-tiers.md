...
- For newer Claude Opus display names in the form `Claude Opus X.Y`, use Cursor's hyphenated model ID form for the version: `Claude Opus 4.8` → `claude-opus-4-8`; `Claude Opus 4.7 (fast mode)` → `claude-opus-4-7-fast`

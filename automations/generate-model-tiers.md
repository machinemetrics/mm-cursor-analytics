...
- Normalize Anthropic rows that put the family before the version to Cursor ID order, with the version before the family: `Claude Opus 4.7 (fast mode)` → `claude-4.7-opus-fast`

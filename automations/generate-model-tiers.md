...
1. Find the table whose trimmed header cells are `Model | Provider | Input | Cache write | Cache read | Output | Notes` (the raw markdown table may include padded spacing for alignment)

...
Fetch the raw markdown. As of 2026-09-02 the page has **two** tables with columns: Model | Provider | Input | Cache write | Cache read | Output | Notes:

- **Cursor Models** (first-party): Grok 4.6, Grok 4.5, Composer 2.5, and their Fast variants
- **Other Models** under `### Model pricing`: third-party models (including Gemini 3.7 Flash and Claude Fable 5.1)
...
2. Download chunks and find the pricing catalog (search for `id:"auto-cost"` or `id:"grok-4.6"` together with `output:`). The chunk hash changes over time (2026-09-02: `0~ms10zi70-sr.js`; 2026-09-01 through 2026-08-25: `07q5_bowxn4is.js`; was `0p1ggu34p8cgd.js` on 2026-08-23; was `0qfcspezy5-zl.js` on 2026-08-21).
...
- Typical size: markdown row count + `auto` (e.g. 48 + 1 = 49 as of 2026-09-02)

...
- Normalize Anthropic Claude family/version order to `claude-<version>-<family>` even when the display name is reversed: `Claude Opus 4.7 (Fast mode)` → `claude-4.7-opus-fast`

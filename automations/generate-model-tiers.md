...
- Normalize Anthropic rows that put the family before the version back to Cursor's version-first ID shape: `Claude Opus 4.7 (fast mode)` → `claude-4.7-opus-fast`

...
- Added current model entries and pricing for Composer 2, GPT-5.4 Mini, GPT-5.4 Nano, and Grok 4.20.
- Updated `lastUpdated` and retained required `auto` (`cheap`, output `6`) tier metadata.

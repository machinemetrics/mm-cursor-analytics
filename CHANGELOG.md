...
- Added current models/prices (including Composer 2, GPT-5.4 Mini/Nano, and Grok 4.20) and removed stale entries.
- Refreshed `lastUpdated` timestamp and preserved `auto` as a cheap-tier model.

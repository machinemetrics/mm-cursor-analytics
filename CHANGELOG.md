...
### Changed
- Regenerated `model_tiers.json` from current Cursor models and pricing (added Gemini 3.7 Flash, Grok 4.6, Composer 2.5, and other current models; Claude Sonnet 5 output $10; Grok 4.5 Fast output $18)

...
- Added current models and prices including Composer 2, GPT-5.4 Mini/Nano, and Grok 4.20.
- Removed stale aliases not present in the pricing table to keep tier mapping current.

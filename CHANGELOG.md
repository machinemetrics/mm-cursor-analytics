...
### Changed
- Regenerated model tiers from the Cursor models and pricing docs.
- Added generation guidance for Claude Opus fast-mode aliases and known Cursor state aliases.

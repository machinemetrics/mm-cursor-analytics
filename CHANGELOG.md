...
- Added new model entries from docs updates (`composer-2`, `gpt-5.4-mini`, `gpt-5.4-nano`, `grok-4.20`).
- Kept required `auto` (`cheap`) and Kimi provider-path compatibility entry.

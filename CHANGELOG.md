...
### Changed
- Regenerated `model_tiers.json` from current Cursor models and pricing (48 markdown rows + auto; added Claude Fable 5.1 at $50; includes Grok 4.6, Composer 2.5, Gemini 3.7 Flash, Claude Sonnet 5 at $10, Grok 4.5 Fast at $18, GPT-5.6 Sol promotional output $20)

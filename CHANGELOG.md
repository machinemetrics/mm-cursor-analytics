...
### Changed
- Regenerated `model_tiers.json` from the latest Cursor Models & Pricing table.
- Added new model IDs: `composer-2`, `gpt-5.4-mini`, `gpt-5.4-nano`, and `grok-4.20`.
- Removed stale IDs no longer present in docs: `grok-code`, `accounts/fireworks/models/kimi-k2-instruct`, and `composer`.

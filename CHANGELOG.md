...
### Changed
- Regenerated model tiers from the current Cursor models and pricing table.
- Updated model tier generation notes for current Claude Opus model IDs and fast-mode aliases.
